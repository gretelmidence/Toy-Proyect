 ...
 const ProductView = () => {
  ...
  const storeDetailData = () => {
    const displayStores = product?.deals ? product.deals.map(store => {
      ...
      const currentStoreImg = currentStore?.images ? "https://img.icons8.com/64/000000/controller.png" : "https://img.icons8.com/64/000000/controller.png";
      return {
        ...store,
     ...
     displayStores.map(store => {
       return (
        <Grid className="product-store-box" key={`storeid-${store.storeID}`}>
            ...
            <img className="img" src={store.storeImg}/>
